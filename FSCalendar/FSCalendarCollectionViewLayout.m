...
- (void)prepareLayout
{
    ...
    free(self.heights);
    self.heights = ({
        NSInteger rowCount = self.calendar.transitionCoordinator.representingScope == FSCalendarScopeWeek ? 1 : (self.calendar.placeholderType == FSCalendarPlaceholderTypeFillHeadTail ? 5 : 6);
